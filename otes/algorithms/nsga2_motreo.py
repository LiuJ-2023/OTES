"""NSGA-II with MOTrEO (probabilistic model-based) knowledge transfer"""

import numpy as np
import warnings

from otes.algorithms.base_extended import GeneticAlgorithmMOTrEO
...
class NSGA2_MOTrEO(GeneticAlgorithmMOTrEO):
    """NSGA-II with MOTrEO (Multi-Objective Transfer Evolutionary Optimization)."""
...
parse_doc_string(NSGA2_MOTrEO.__init__)
