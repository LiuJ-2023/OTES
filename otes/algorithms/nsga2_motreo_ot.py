"""NSGA-II with MOTrEO-OT (MOTrEO combined with Optimal Transport)"""

import numpy as np
import warnings

from otes.algorithms.base_extended import GeneticAlgorithmOptimalTransportMOTrEO
...
class NSGA2_MOTrEO_OT(GeneticAlgorithmOptimalTransportMOTrEO):
    """NSGA-II with MOTrEO-OT (MOTrEO combined with Optimal Transport)."""
...
parse_doc_string(NSGA2_MOTrEO_OT.__init__)
