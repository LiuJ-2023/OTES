"""Probabilistic model-based search and transfer in continuous spaces"""
...
class ProbabilisticModel(object):
    """Probabilistic model for solution sampling."""
    ...
    def buildModel(self, solutions):
        ...
        if self.type == 'mvarnorm':
            ...
            solutions_noisy = np.concatenate((solutions, np.random.rand(int(0.2*pop), self.dim)), axis=0)
...
class MixtureModel(object):
    """Mixture model for multiple probabilistic models."""
    ...
    def EMstacking(self):
        ...
        for _ in range(iterations):
            ...
            self.alpha = np.around(talpha, decimals=5)
